...
const { createKategoriBerita, getDetailKategoriBerita,updateKategoriBerita, deleteKategoriBerita, createBerita,getBerita,updateBerita,deleteBerita,uploadBeritaFiles, getAllKategoriBerita, getAllBerita, getSampul } = require('../../controllers/beritaControllers/berita');
...
router.get('/getDetailKategoriBerita/:id', authMiddleware, getDetailKategoriBerita); // Endpoint to get news category by ID
...
router.get('/getBerita/:id', authMiddleware, getBerita); // Endpoint to get all
